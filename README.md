<html>
      <title> історичні монети </title>
       <body style="background-color:#BC8F8F">
                  <header>
                        <h1 style="color:sienna">історичні монети</h1>
                  </header>

                              <main>
                                    <h2 style="color:maroon">інформація про монети</h2>

                                     <i><b>Перше знайомство людства з грошима відбулося ще кілька тисяч років тому, коли люди почали замислюватися над тим, що всі речі мають певну ціну.</b> <p></p>
